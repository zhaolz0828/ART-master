...
import tensorflow.cloudbio.distributions as ds
...
n_reliability_d2=3 
n_training=800
M,MV_result,Ground_Truth=dataProcess.Process(n_states,'DataACT_Real_Modify_Level2.csv')
...
def train(data, learning_rate=0.001,training_epochs=10, display_step=1):
    ...
    for epoch in range(training_epochs): 
        ...
        if epoch > 780 and cost_val[-1] > np.mean(cost_val[-10:-1]): 
